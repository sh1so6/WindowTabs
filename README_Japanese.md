...
最新のバージョン: **ss_jp_2026.02.23_next_1**
...
ブラウザのピン止めタブと同様に、タブをタブストリップの左側に固定配置できます。

- **ピン止め/解除**: タブを右クリックして「タブのピン止め」サブメニューから操作
- **ピン止めタブの表示**: ピン止めタブは左側に狭い幅で表示され、ピン解除ボタン（傾いた画鋲アイコン）が常時表示されます
- **VSCodeスタイルのゾーン間ドラッグ＆ドロップ**: タブをピン止めゾーンにドラッグすると自動でピン止め、非ピン止めゾーンにドラッグすると自動で解除
- **幅の設定**: 外観設定で「アイコンのみ」またはカスタム幅を指定可能
- **ピンアイコン**: Segoe MDL2 Assetsシステムフォントを使用した高品質描画
