...
module Localization_English =
    let strings = dict [
        ...
        ("MouseOver Text Color", "Mouse Over Text Color")
        ("Active Text Color", "Active Text Color")
        ("Flash Text Color", "Flash Text Color")
        ("Inactive Tab Color", "Inactive Tab Color")
        ("MouseOver Tab Color", "Mouse Over Tab Color")
        ("Active Tab Color", "Active Tab Color")
        ("Flash Tab Color", "Flash Tab Color")
        ("Inactive Border Color", "Inactive Border Color")
        ("MouseOver Border Color", "Mouse Over Border Color")
        ("Active Border Color", "Active Border Color")
        ("Flash Border Color", "Flash Border Color")
        ...
        ("DetachTabMoveTop", "Display top edge")
        ("DetachTabMoveBottom", "Display bottom edge")
        ("Display", "Display")
        ("Left", "Left")
        ("Right", "Right")
        ("Up", "Up")
