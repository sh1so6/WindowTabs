...
module Localization_English =
    let strings = dict [
        ...
        ("Background Flash", "Background Flash")
        ...
        ("Indent Flipped", "Distance from edge when tabs down (pixels)")
        ("Indent Normal", "Distance from edge when tabs up (pixels)")
        ...
        ("HideTabsWhenDown", "Hide tabs when positioned at bottom")
        ("hideTabsDelayMilliseconds", "Hide tabs when positioned at bottom - wait time (milliseconds)")
