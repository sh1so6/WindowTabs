...
module Localization_English =
    let strings = dict [
        ...
        ("TabColorEmeraldGreen", "Emerald Green")
        ("TabColorLightBlue", "Light Blue")
        ...
        ("TabColorEmeraldGreenUnderline", "Emerald Green Underline")
        ("TabColorLightBlueUnderline", "Light Blue Underline")
