...
module Localization_English =
    let strings = dict [
        ...
        ("MoveEdgeRight", "Move Right")
        ("MoveEdgeLeft", "Move Left")
        ("MoveEdgeTop", "Move Top")
        ("MoveEdgeBottom", "Move Bottom")
        ("MoveEdgeTopLeft", "Move Top Left")
        ("MoveEdgeTopRight", "Move Top Right")
        ("MoveEdgeBottomLeft", "Move Bottom Left")
        ("MoveEdgeBottomRight", "Move Bottom Right")
        ("MoveCorner", "Move Corner")
        ("SnapLeft", "Snap Left")
        ("SnapRight", "Snap Right")
        ("MovePositionOther", "Reposition Other")
        ("SnapLeftPercent", "Snap Left {0}%")
        ("SnapRightPercent", "Snap Right {0}%")
        ("SnapTop", "Snap Top")
        ("SnapTopPercent", "Snap Top {0}%")
        ("SnapBottom", "Snap Bottom")
        ("SnapBottomPercent", "Snap Bottom {0}%")
        ("SnapPercent", "Snap {0}%")
        ("Display", "Display")
        ("Left", "Left")
        ("Right", "Right")
