...
module Localization_English =
    let strings = dict [
        ...
        ("Background Normal", "Inactive Background Color")
        ("Background Highlight", "Mouse Hover Background Color")
        ("Background Active", "Active Background Color")
        ("Background Flash", "Flash Background Color")
        ("Border", "Border Color")
