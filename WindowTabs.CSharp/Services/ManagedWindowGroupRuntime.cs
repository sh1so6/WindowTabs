...
{
    internal sealed class ManagedWindowGroupRuntime : IWindowGroupRuntime
    {
        private readonly List<IntPtr> windowHandles = new List<IntPtr>();

        public ManagedWindowGroupRuntime(IntPtr groupHandle)
        {
        ...
        public void SwitchWindow(bool next, bool force)
        {
            ...
            var targetHandle = windowHandles[targetIndex];
